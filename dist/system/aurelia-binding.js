...
System.register(['aurelia-logging', 'aurelia-pal', 'aurelia-task-queue', 'aurelia-metadata'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      T_Identifier = 1 << 12 | T_IdentifierOrKeyword;
      T_NumericLiteral = 1 << 13;
      T_StringLiteral = 1 << 14;
      T_BinaryOperator = 1 << 15;
      T_UnaryOperator = 1 << 16;
      T_IdentifierOrKeyword = 1 << 17;
      T_FalseKeyword = 0 | T_IdentifierOrKeyword;
      T_TrueKeyword = 1 | T_IdentifierOrKeyword;
      T_NullKeyword = 2 | T_IdentifierOrKeyword;
      T_UndefinedKeyword = 3 | T_IdentifierOrKeyword;
      T_ThisScope = 4 | T_IdentifierOrKeyword;
      T_ParentScope = 5 | T_IdentifierOrKeyword;
      T_LParen = 6 | T_AccessScopeTerminal;
      T_LBrace = 7;
      T_Period = 8;
      T_RBrace = 9 | T_AccessScopeTerminal | T_ClosingToken;
      T_RParen = 10 | T_AccessScopeTerminal | T_ClosingToken;
      T_Semicolon = 11;
      ...
      T_BarBar = 21 | 1 << T_PrecedenceShift | T_BinaryOperator;
      T_AmpersandAmpersand = 22 | 2 << T_PrecedenceShift | T_BinaryOperator;
      T_Caret = 23 | 3 << T_PrecedenceShift | T_BinaryOperator;
      T_EqEq = 24 | 4 << T_PrecedenceShift | T_BinaryOperator;
      T_BangEq = 25 | 4 << T_PrecedenceShift | T_BinaryOperator;
      T_EqEqEq = 26 | 4 << T_PrecedenceShift | T_BinaryOperator;
      T_BangEqEq = 27 | 4 << T_PrecedenceShift | T_BinaryOperator;
      T_Lt = 28 | 5 << T_PrecedenceShift | T_BinaryOperator;
      T_Gt = 29 | 5 << T_PrecedenceShift | T_BinaryOperator;
      T_LtEq = 30 | 5 << T_PrecedenceShift | T_BinaryOperator;
      T_GtEq = 31 | 5 << T_PrecedenceShift | T_BinaryOperator;
      T_Plus = 32 | 6 << T_PrecedenceShift | T_BinaryOperator | T_UnaryOperator;
      T_Minus = 33 | 6 << T_PrecedenceShift | T_BinaryOperator | T_UnaryOperator;
      T_Star = 34 | 7 << T_PrecedenceShift | T_BinaryOperator;
      T_Percent = 35 | 7 << T_PrecedenceShift | T_BinaryOperator;
      T_Slash = 36 | 7 << T_PrecedenceShift | T_BinaryOperator;
      T_Eq = 37;
      ...
      TokenValues = [false, true, null, undefined, '$this', '$parent', '(', '{', '.', '}', ')', ';', ',', '[', ']', ':', '?', '\'', '"', '&', '|', '||', '&&', '^', '==', '!=', '===', '!==', '<', '>', '<=', '>=', '+', '-', '*', '%', '/', '=', '!'];
